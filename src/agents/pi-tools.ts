...
import { loadAllSkillJsonTools } from "./skills/skill-json-loader.js";
import { createSkillJsonTools } from "./skills/skill-json-tool-factory.js";
...
export function createOpenClawCodingTools(options?: {
  ...
  // Load skill.json tools from workspace
  const skillJsonTools: AnyAgentTool[] = workspaceRoot
    ? createSkillJsonTools(
        loadAllSkillJsonTools({
